...
export const tripsAPI = {
  ...
  addReview: (id: string, data: any) => api.post(`/trips/${id}/review`, data),
...
export const driversAPI = {
  getAvailableVehicles: () => api.get("/drivers/available-vehicles"),
  ...
  reviewAssignment: (id: string, status: "approved" | "rejected") =>
    api.patch(`/drivers/assignments/${id}/review`, { status }),

  updateAssignmentStatus: (id: string, status: "active" | "inactive") =>
...
export const adminAPI = {
  ...
  getVehicles: (params?: any) => api.get("/admin/vehicles", { params }),

  deleteVehicle: (id: string) => api.delete(`/admin/vehicles/${id}`),

  getTrips: (params?: any) => api.get("/admin/trips", { params }),
